...
- 新runtime将从空经验运行完整12对probe，普通业务失败后继续固定任务序列。48对formal仍未启动，当前发布继续使用金融12项candidate，直到新实验完整通过扩大门槛。完整历史见 [三场景预检](cross-domain-attribution-probe-results-2026-09-15.md)。
