...
调研日期：2026-09-08；模型验证与真实平台部署状态更新于 2026-09-09。ERPNext、Zammad 已在 v100 部署并完成合成数据 API 验收，详见 [部署验证](platform-deployment-validation-2026-09-09.md)。结论区分官方文档支持、客户端协议验证和真实部署验证，不以仓库存在或 HTTP 首页可达代替业务可用性。
