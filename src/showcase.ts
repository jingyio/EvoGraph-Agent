...
export type PairDetail = ShowcasePair & {
  ...
  runs: { baseline: CompactRun & { graphNodes: GraphNode[]; steps: Step[]; report: Record<string, unknown> }; rsi: CompactRun & { graphNodes: GraphNode[]; steps: Step[]; report: Record<string, unknown> } };
};
