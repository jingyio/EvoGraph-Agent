...
const pages = { home: '运营助手', compare: '验证与对照', live: '现场演示', insights: 'RSI 运行时', replay: '执行记录', demo: '历史执行工作台', evaluation: '成对评测与成果', evolution: '随任务进化', taskbank: '真实数据任务库', platforms: '平台只读工作台' };
