...
const pages = { home: '概览', compare: '对比测试', live: '在线对照', insights: 'RSI 效果分析', replay: '任务回放', demo: '历史执行工作台', evaluation: '成对评测与成果', evolution: '随任务进化', taskbank: '真实数据任务库', platforms: '平台只读工作台' };
